...
public class HackedTestingMySqlServer implements Closeable {
    ...
    public String getJdbcUrl(final String database) {
        return format("jdbc:mysql://mysql01.sit.leoao.com:3306/%s?user=%s&password=%s&useSSL=false&allowPublicKeyRetrieval=true&createDatabaseIfNotExist=true&allowMultiQueries=true", port, database, user, password);
    }
}
